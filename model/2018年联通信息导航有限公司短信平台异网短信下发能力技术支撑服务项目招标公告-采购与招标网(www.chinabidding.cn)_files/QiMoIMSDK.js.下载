...
var peers = undefined
var selectPeer = ''
var seoUrl = qimo_config.referrer   // 获取真实来路
var seoSource = ''  // 搜索来源
...
function QiMoIMSDK () {
  ...
  this.loadStyle = function () {
    ...
    if (utils.isFromMobile()) {
      style.href = qimo_config.chatHost + '/stylesheets/chatStyle_wap.css?1010'
      var body = document.getElementsByTagName('body')
      body[0].setAttribute('data-7m', '7m_warp')
    } else {
      style.href = qimo_config.chatHost + '/stylesheets/chatStyle.css?09211'
    }
