            ...
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    ...
                    <tr>
                        ...
                        <td>1</td>
                        <td><img  src="./images/banner.png" width="200" alt="">点击图片试试</td>
                        <td >http://www.xuebingsi.com</td>
                        <td >十月活动轮播</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="javascript:;" onclick="banner_edit('编辑','banner-edit.html','4','','510')" class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="banner_del(this,'1')" style="text-decoration:none">
                                <i class="layui-icon">&#xe640;</i>
                            </a>
                        </td>
                    </tr>
