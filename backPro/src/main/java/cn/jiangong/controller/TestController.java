...
public class TestController {
    ...
    public String login(){
        String login = "成功";
        if(userService.selectUserList("s", "s") == null){
            login = "失败";
        }
        return login;
    }
