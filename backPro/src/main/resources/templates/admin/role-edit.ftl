...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form action="" method="post" class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" required lay-verify="required"
                               value="<#if RequestParameters['name']??>${RequestParameters['name']}</#if>"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" id="desc" name="desc" class="layui-textarea"><#if RequestParameters['comment']??>${RequestParameters['comment']}</#if></textarea>
                    </div>
                </div>
        ...
        <input type="hidden" id="roleId" value="<#if RequestParameters['roleId']??>${RequestParameters['roleId']}</#if>">
        <script>
